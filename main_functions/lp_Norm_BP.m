% LP_NORM_BP - Beampattern Shaping for MIMO Radars Using BSUM Method
%
...
%
% Usage:
% [POpt, mu, objfunVal, solConv, S] = lp_Norm_BP(Mt, Nc, p, L, theta, thetaDes, varargin)
%
% Inputs:
...
%   varargin - Name-value pairs for 'draw', 'result', 'mu', 'iter', 'seed'.
%
% Outputs:
...
function [POpt, mu, objfunVal, solConv, S] = lp_Norm_BP(Mt,Nc,p,L,theta,thetaDes,varargin)
